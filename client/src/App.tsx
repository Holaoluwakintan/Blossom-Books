...
import Community, { AuthorPage, CommunityGuidelines, JournalPage, Notifications } from "./pages/Community";
...
function Router() { return <Switch>
  <Route path="/" component={Home} /><Route path="/discover" component={Discover} /><Route path="/library" component={Library} /><Route path="/create" component={WriterStudio} /><Route path="/write" component={WriterStudio} /><Route path="/studio/books" component={BookStudio} /><Route path="/admin/books" component={AdminBooks} /><Route path="/admin/moderation" component={AdminModeration} /><Route path="/profile" component={ProfilePage} /><Route path="/delete-account" component={DeleteAccountPage} /><Route path="/community" component={Community} /><Route path="/community-guidelines" component={CommunityGuidelines} /><Route path="/notifications" component={Notifications} /><Route path="/authors/:slug" component={AuthorPage} /><Route path="/journal/:slug" component={JournalPage} /><Route path="/book/:id" component={BookDetail} /><Route path="/read/:id" component={Reader} /><Route component={NotFoundPage} />
</Switch>; }
